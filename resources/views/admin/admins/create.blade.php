...
<div class="card mx-5">
    <div class="card-body">
        <h5 class="card-title">{{ __('Create Account') }}</h5>
        <div class="row">
            <div class="col-12">
                <form action="{{ route('admin.admins.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fullname" value="{{ old('fullname') }}" class="form-control form-control-prepend">
                        @error("fullname")
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="mail_address" value="{{ old('mail_address') }}" class="form-control form-control-prepend">
                        @error("mail_address")
                        <div class="text-danger mt-1">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="role" class="form-control">
                            ...
                            <option value="{{ $role->value }}" @selected($role->value == old('role'))>
                                {{ $role->getDescription() }}
                            </option>
                            @endforeach
                        </select>
