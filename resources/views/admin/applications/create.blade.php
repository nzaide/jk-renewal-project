...
<div class="card mx-5">
    <div class="card-body">
        <h5 class="card-title">{{ __('New Application') }}</h5>
        <div class="row">
            <div class="col-12">
                <form action="{{ route('admin.applications.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="applied_date" value="{{ old('applied_date') }}" class="form-control flatpickr">
                        @error("applied_date")
                    ...
                    <div class="form-group">
                        ...
                        <div data-toggle="modal" data-target="#adminModal" @click="fetchData('admins')">
                            <input
                                ...
                                readonly
                            >
                            <input type="hidden" id="adminId" name="admin_id" value="{{ old('admin_id') }}">
                        </div>
                        @error("admin_id")
                        <div class="text-danger mt-1">
                            {{ Str::ucfirst($message) }}
                    ...
                    <div class="form-group">
                        ...
                        <div data-toggle="modal" data-target="#jobSeekerModal" @click="fetchData('job_seekers')">
                            <input
                                ...
                                type="text"
                                value="{{ old('job_seeker_name') }}"
                                class="form-control"
                                readonly
                            >
                            <input type="hidden" id="jobSeekerId" name="job_seeker_id" value="{{ old('job_seeker_id') }}">
                        </div>
                        @error("job_seeker_id")
                        <div class="text-danger mt-1">
                            {{ Str::ucfirst($message) }}
                    ...
                    <div class="form-group">
                        ...
                        <div data-toggle="modal" data-target="#jobPostModal" @click="fetchData('job_posts')">
                            <input
                                ...
                                name="job_post_name"
                                type="text"
                                value="{{ old('job_post_name') }}"
                                class="form-control"
                                readonly
                            >
                            <input type="hidden" id="jobPostId" name="job_post_id" value="{{ old('job_post_id') }}">
                        </div>
                        @error("job_post_id")
                        <div class="text-danger mt-1">
                            {{ Str::ucfirst($message) }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nationality" value="{{ old('nationality') }}" class="form-control form-control-flush pl-3 bg-neutral border-bottom" id="nationality" readonly>
                    </div>
                    <div class="form-group">
                        <label class="form-control-label">{{ __('Language fluency') }}</label>
                        <input type="text" name="langugage_fluency" value="{{ old('langugage_fluency') }}" class="form-control form-control-flush pl-3 bg-neutral border-bottom" id="languageFluency" readonly>
                    </div>
                    <div class="form-group">
                        <label class="form-control-label">{{ __('Current Salary') }}</label>
                        <input type="text" name="current_salary" value="{{ old('current_salary') }}" class="form-control form-control-flush pl-3 bg-neutral border-bottom" id="currentSalary" readonly>
                    </div>
                    <div class="form-group">
                        <label class="form-control-label">{{ __('Expected Salary') }}</label>
                        <input type="text" name="expected_salary" value="{{ old('expected_salary') }}" class="form-control form-control-flush pl-3 bg-neutral border-bottom" id="expectedSalary" readonly>
                    </div>
                    <div class="form-group">
                        ...
                        <div>
                            <select class="form-control" name="application_status">
                                ...
                                <option value="{{ $status->value }}" @selected($status->value == old('application_status'))>
                                    {{ $status->text() }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="final_remarks" class="form-control">{{ old('final_remarks') }}</textarea>
                        @error("final_remarks")
                        <div class="text-danger mt-1">
                            {{ Str::ucfirst($message) }}
                        </div>
...
@vite('resources/js/admin/applications/create.js')
@endpush
