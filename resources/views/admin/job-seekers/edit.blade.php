...
<form action="{{ route('admin.job-seekers.update', $jobSeeker) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="card mx-5">
        <div class="card-body">
            <h5 class="card-title">{{ __('Edit jobseeker') }}</h5>
            <div class="row">
                <div class="col-12">
                    <div class="form-row">
                        <div class="form-group col-6">
                            <label class="form-control-label">{{ __('Date interviewed') }} <i class="text-danger">*</i></label>
                            <input type="text" name="interview_date" value="{{ old('interview_date', $jobSeeker->interview_date) }}" class="form-control flatpickr">
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="job_posting" value="{{ old('job_posting', $jobSeeker->job_posting) }}" class="form-control">
                            @error("job_posting")
                            <div class="text-danger mt-1">
                                {{ Str::ucfirst($message) }}
                            </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="fullname" value="{{ old('fullname', $jobSeeker->fullname) }}" class="form-control">
                            @error("fullname")
                            <div class="text-danger mt-1">
                                {{ Str::ucfirst($message) }}
                            </div>
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="english_name" value="{{ old('english_name', $jobSeeker->english_name) }}" class="form-control">
                            @error("english_name")
                            <div class="text-danger mt-1">
                                {{ Str::ucfirst($message) }}
                            </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            <div>
                                <select class="form-control" name="gender">
                                    ...
                                    <option value="{{ $gender->value }}" @selected($gender->value == old('gender', $jobSeeker->gender))>
                                        {{ $gender->text() }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="birth_date" value="{{ old('birth_date', $jobSeeker->birth_date) }}" class="form-control flatpickr">
                            @error("birth_date")
                            <div class="text-danger mt-1">
                                {{ Str::ucfirst($message) }}
                            </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            >
                                ...
                                <option value="{{ $phLocation->id }}" @selected(in_array($phLocation->id, old('location_philippines', $jobSeeker->locations->modelKeys())))>
                                    {{ $phLocation->location }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-6">
                            ...
                            >
                                ...
                                <option value="{{ $abLocation->id }}" @selected(in_array($abLocation->id, old('location_abroad', $jobSeeker->locations->modelKeys())))>
                                    {{ $abLocation->location }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-6">
                            ...
                            <div>
                                <select class="form-control" name="marital_status">
                                    ...
                                    <option value="{{ $maritalStatus->value }}" @selected($maritalStatus->value == old('marital_status', $jobSeeker->marital_status))>
                                        {{ $maritalStatus->text() }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group col-6">
                            ...
                            <div>
                                <select class="form-control" name="visa_id">
                                    ...
                                    <option value="{{ $visa->value }}" @selected($visa->value == old('visa_id', $jobSeeker->visa_id))>
                                        {{ $visa->text() }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group col-6">
                            ...
                            <div>
                                <select class="form-control" name="nationality_id">
                                    ...
                                    <option value="{{ $nationality->id }}" @selected($nationality->id == old('nationality_id', $jobSeeker->nationality_id))>
                        ...
                        <div class="form-group col-6">
                            ...
                            <div>
                                <select class="form-control" name="english_fluency">
                                    ...
                                    <option value="{{ $fluency->value }}" @selected($fluency->value == old('english_fluency', $jobSeeker->english_fluency))>
                                        {{ $fluency->text() }}
                                    </option>
                                    @endforeach
                                </select>
                                ...
                                >
                                    ...
                                    <optgroup>
                                        <option
                                            value="{{ $language->id . ',0' }}"
                                            class="ml-n2"
                                            @selected($language->id . ',0' == old('language_first', $jobSeeker->language_first_id . ',' . intval($jobSeeker->language_first_fluency)))
                                        >
                                            {{ $language->language }}
                                        </option>
                                        ...
                                        <option
                                            ...
                                            @selected($language->id . ',' . $fluency->value == old('language_first', $jobSeeker->language_first_id . ',' . $jobSeeker->language_first_fluency))
                                        >
                                ...
                                >
                                    ...
                                    <optgroup>
                                        <option
                                            value="{{ $language->id . ',0' }}"
                                            class="ml-n2"
                                            @selected($language->id . ',0' == old('language_second', $jobSeeker->language_second_id . ',' . intval($jobSeeker->language_second_fluency)))
                                        >
                                            {{ $language->language }}
                                        </option>
                                        @foreach ($fluencies as $fluency)
                                        <option
                                            value="{{ $language->id . ',' . $fluency->value }}"
                                            data-content="{{ $fluency->text() }}<span class='d-none'>{{ $language->language }}</span>"
                                            @selected($language->id . ',' . $fluency->value == old('language_second', $jobSeeker->language_second_id . ',' . $jobSeeker->language_second_fluency))
                                        >
                                            {{ $language->language . ': ' . $fluency->text() }}
                                        </option>
                                        @endforeach
                                ...
                                >
                                    <optgroup label="Speaking">
                                        ...
                                        <option
                                            ...
                                            @selected(in_array('s,' . $i, old('language_second_skills', ['s,' . $jobSeeker->language_second_speaking])))
                                        >
                                            {{ 'Speaking: ' . $i }}
                                        </option>
                                        @endfor
                                    ...
                                    <optgroup label="Reading">
                                        ...
                                        <option
                                            ...
                                            @selected(in_array('r,' . $i, old('language_second_skills', ['r,' . $jobSeeker->language_second_reading])))
                                        >
                                            {{ 'Reading: ' . $i }}
                                        </option>
                                        @endfor
                                    ...
                                    <optgroup label="Writing">
                                        ...
                                        <option
                                            ...
                                            @selected(in_array('w,' . $i, old('language_second_skills', ['w,' . $jobSeeker->language_second_writing])))
                                        >
                                            {{ 'Writing: ' . $i }}
                                        </option>
                                        @endfor
                                ...
                                >
                                    ...
                                    <optgroup>
                                        <option
                                            value="{{ $language->id . ',0' }}"
                                            class="ml-n2"
                                            @selected($language->id . ',0' == old('language_third', $jobSeeker->language_third_id . ',' . intval($jobSeeker->language_third_fluency)))
                                        >
                                            {{ $language->language }}
                                        </option>
                                        @foreach ($fluencies as $fluency)
                                        <option
                                            value="{{ $language->id . ',' . $fluency->value }}"
                                            data-content="{{ $fluency->text() }}<span class='d-none'>{{ $language->language }}</span>"
                                            @selected($language->id . ',' . $fluency->value == old('language_third', $jobSeeker->language_third_id . ',' . $jobSeeker->language_third_fluency))
                                        >
                                            {{ $language->language . ': ' . $fluency->text() }}
                                        </option>
                                        @endforeach
                                ...
                                >
                                    <optgroup label="Speaking">
                                        ...
                                        <option
                                            value="{{ 's,' . $i }}"
                                            data-content="{{ $i }}<span class='d-none'>Speaking</span>"
                                            @selected(in_array('s,' . $i, old('language_third_skills', ['s,' . $jobSeeker->language_third_speaking])))
                                        >
                                            {{ 'Speaking: ' . $i }}
                                        </option>
                                        @endfor
                                    ...
                                    <optgroup label="Reading">
                                        ...
                                        <option
                                            value="{{ 'r,' . $i }}"
                                            data-content="{{ $i }}<span class='d-none'>Reading</span>"
                                            @selected(in_array('r,' . $i, old('language_third_skills', ['r,' . $jobSeeker->language_third_reading])))
                                        >
                                            {{ 'Reading: ' . $i }}
                                        </option>
                                        @endfor
                                    ...
                                    <optgroup label="Writing">
                                        ...
                                        <option
                                            value="{{ 'w,' . $i }}"
                                            data-content="{{ $i }}<span class='d-none'>Writing</span>"
                                            @selected(in_array('w,' . $i, old('language_third_skills', ['w,' . $jobSeeker->language_third_writing])))
                                        >
                                            {{ 'Writing: ' . $i }}
                                        </option>
                                        @endfor
                    ...
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            <textarea name="profile" class="form-control">{{ old('profile', $jobSeeker->profile) }}</textarea>
                            @error("profile")
                            <div class="text-danger mt-1">
                                {{ Str::ucfirst($message) }}
                            </div>
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="contact_number" value="{{ old('contact_number', $jobSeeker->contact_number) }}" class="form-control">
                    ...
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="mail_address" value="{{ old('mail_address', $jobSeeker->mail_address) }}" class="form-control">
                            @error("mail_address")
                            <div class="text-danger mt-1">
                                {{ Str::ucfirst($message) }}
                            </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="landline" value="{{ old('landline', $jobSeeker->landline) }}" class="form-control">
                            @error("landline")
                            <div class="text-danger mt-1">
                                {{ Str::ucfirst($message) }}
                            </div>
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="social_media" value="{{ old('social_media', $jobSeeker->social_media) }}" class="form-control">
                            @error("social_media")
                            <div class="text-danger mt-1">
                                {{ Str::ucfirst($message) }}
                            </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            <textarea name="other_contact" class="form-control">{{ old('other_contact', $jobSeeker->other_contact) }}</textarea>
                            @error("other_contact")
                            <div class="text-danger mt-1">
                                {{ Str::ucfirst($message) }}
                            </div>
                                ...
                                >
                                    ...
                                    <optgroup label="{{ $highestDegree->text() }}">
                                        ...
                                        <option
                                            ...
                                            @selected($highestDegree->value . ',' . $level->value == old('education', $jobSeeker->highest_degree . ',' . $jobSeeker->education_level))
                                        >
                                    ...
                                    <option
                                        ...
                                        @selected($highestDegree->value . ',0' == old('education', $jobSeeker->highest_degree . ',' . $jobSeeker->education_level))
                                    >
                                        {{ $highestDegree->text() }}
                                    </option>
                                    @endif
                        ...
                        <div class="form-group col-6">
                            ...
                            <div>
                                <select class="form-control" name="employment_status">
                                    ...
                                    <option value="{{ $status->value }}" @selected($status->value == old('employment_status', $jobSeeker->employment_status))>
                                        {{ $status->text() }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group col-6">
                            ...
                            <div>
                                <select class="form-control" name="university_major">
                                    ...
                                    <option value="{{ $major->value }}" @selected($major->value == old('university_major', $jobSeeker->university_major))>
                                        {{ $major->text() }}
                                    </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="present_employer" value="{{ old('present_employer', $jobSeeker->present_employer) }}" class="form-control">
                        ...
                        <div class="form-group col-6">
                            ...
                            <div>
                                <select class="selectpicker w-100" name="industry_ids[]" multiple data-live-search="true">
                                    ...
                                    <option value="{{ $industry->id }}" @selected(in_array($industry->id, old('industry_ids', $jobSeeker->industries->modelKeys())))>
                                        {{ $industry->name }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group col-6">
                            ...
                            <div>
                                <select class="selectpicker w-100" name="job_field_ids[]" multiple data-live-search="true">
                                    ...
                                    <option value="{{ $jobField->id }}" @selected(in_array($jobField->id, old('job_field_ids', $jobSeeker->jobFields->modelKeys())))>
                                        {{ $jobField->name }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group col-6">
                            ...
                            <div>
                                <select class="selectpicker w-100" name="license_ids[]" multiple data-live-search="true">
                                    ...
                                    <option value="{{ $license->id }}" @selected(in_array($license->id, old('license_ids', $jobSeeker->licenses->modelKeys())))>
                                        {{ $license->name }}
                                    </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="start_availability" value="{{ old('start_availability', $jobSeeker->start_availability) }}" class="form-control">
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="current_salary" value="{{ old('current_salary', $jobSeeker->current_salary) }}" class="form-control">
                    ...
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="interview_availability" value="{{ old('interview_availability', $jobSeeker->interview_availability) }}" class="form-control">
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="resignation_reason" value="{{ old('resignation_reason', $jobSeeker->resignation_reason) }}" class="form-control">
                    ...
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="expected_salary" value="{{ old('expected_salary', $jobSeeker->expected_salary) }}" class="form-control">
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="pending_application" value="{{ old('pending_application', $jobSeeker->pending_application) }}" class="form-control">
                    ...
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="preferred_shift" value="{{ old('preferred_shift', $jobSeeker->preferred_shift) }}" class="form-control">
                        ...
                        <div class="form-group col-6">
                            ...
                            <div>
                                <select class="form-control" name="preferred_employment">
                                    ...
                                    <option value="{{ $type->value }}" @selected($type->value == old('preferred_employment', $jobSeeker->preferred_employment))>
                                        {{ $type->text() }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group col-6">
                            ...
                            <div>
                                <select class="selectpicker w-100" name="job_ids[]" multiple data-live-search="true">
                                    @foreach ($jobs as $job)
                                    <option value="{{ $job->id }}" @selected(in_array($job->id, old('job_ids', $jobSeeker->jobs->modelKeys())))>
                                        {{ $job->name }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group col-6">
                            ...
                            <div>
                                <select class="selectpicker w-100" name="other_tag_ids[]" multiple data-live-search="true">
                                    ...
                                    <option value="{{ $otherTag->id }}" @selected(in_array($otherTag->id, old('other_tag_ids', $jobSeeker->otherTags->modelKeys())))>
                                        {{ $otherTag->name }}
                                    </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="reactivation_date" value="{{ old('reactivation_date', $jobSeeker->reactivation_date) }}" class="form-control flatpickr">
                        ...
                        <div class="form-group col-6">
                            ...
                            <label for="completeBlindResume">
                                {!! $jobSeeker->complete_blind_resume ? '<i class="fas fa-file"></i>' : '<i class="fas fa-upload"></i>' !!}
                            ...
                            <input name="complete_blind_resume_base64" type="hidden" id="completeBlindResumeBase64" value="{{ old('complete_blind_resume_base64', $completeBlindResumeBase64) }}"/>
                    ...
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            <label for="blindResume">
                                {!! $jobSeeker->blind_resume ? '<i class="fas fa-file"></i>' : '<i class="fas fa-upload"></i>' !!}
                                <span id="blindResumeNameDisplay">{{ old('blind_resume_name') ?: __('Choose a file…') }}</span>
                            </label>
                            <small class="form-text text-muted mt-2">{{ __('(pdf/jpg/png/gif/word/excel only, up to 5MB') }}</small>
                            <input name="blind_resume_base64" type="hidden" id="blindResumeBase64" value="{{ old('blind_resume_base64', $blindResumeBase64) }}"/>
                        ...
                        <div class="form-group col-6">
                            ...
                            <label for="originalResume">
                                {!! $jobSeeker->original_resume ? '<i class="fas fa-file"></i>' : '<i class="fas fa-upload"></i>' !!}
                                <span id="originalResumeNameDisplay">{{ old('original_resume_name') ?: __('Choose a file…') }}</span>
                            </label>
                            <small class="form-text text-muted mt-2">{{ __('(pdf/jpg/png/gif/word/excel only, up to 5MB') }}</small>
                            <input name="original_resume_base64" type="hidden" id="originalResumeBase64" value="{{ old('original_resume_base64', $originalResumeBase64) }}"/>
                    ...
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            <label for="shokumuKeirekisho">
                                {!! $jobSeeker->shokumu_keirekisho ? '<i class="fas fa-file"></i>' : '<i class="fas fa-upload"></i>' !!}
                                <span id="shokumuKeirekishoNameDisplay">{{ old('shokumu_keirekisho_name') ?: __('Choose a file…') }}</span>
                            </label>
                            <small class="form-text text-muted mt-2">{{ __('(pdf/jpg/png/gif/word/excel only, up to 5MB') }}</small>
                            <input name="shokumu_keirekisho_base64" type="hidden" id="shokumuKeirekishoBase64" value="{{ old('shokumu_keirekisho_base64', $shokumuKeirekishoBase64) }}"/>
                        ...
                        <div class="form-group col-6">
                            ...
                            <label for="rirekisho">
                                {!! $jobSeeker->rirekisho ? '<i class="fas fa-file"></i>' : '<i class="fas fa-upload"></i>' !!}
                                <span id="rirekishoNameDisplay">{{ old('rirekisho_name') ?: __('Choose a file…') }}</span>
                            </label>
                            <small class="form-text text-muted mt-2">{{ __('(pdf/jpg/png/gif/word/excel only, up to 5MB') }}</small>
                            <input name="rirekisho_base64" type="hidden" id="rirekishoBase64" value="{{ old('rirekisho_base64', $rirekishoBase64) }}"/>
                    ...
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            <textarea name="request" class="form-control">{{ old('request', $jobSeeker->request) }}</textarea>
                            @error("request")
                            <div class="text-danger mt-1">
                                {{ Str::ucfirst($message) }}
                            </div>
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="interviewer" value="{{ old('interviewer', $jobSeeker->interviewer) }}" class="form-control">
                            @error("interviewer")
                            <div class="text-danger mt-1">
                                {{ Str::ucfirst($message) }}
                            </div>
...
@vite('resources/js/admin/job-seekers/edit.js')
@endpush
