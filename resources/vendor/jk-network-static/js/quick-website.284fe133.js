...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"FMkH":[function(require,module,exports) {
// //
// // Layout
// //
//
...
var Popover = function () {
  // Variables
  var $popover = $('[data-toggle="popover"]'); // Methods
...
var Cookies = function () {
  // Variables
  var $modal = $("#modal-cookies"); // Methods
...
var DarkMode = function () {
  ...
  var stylesheet = document.getElementById('stylesheet'); // Config
...
var Dropdown = function () {
  ...
  var $dropdown = $('.dropdown-animate'),
      $dropdownSubmenu = $('.dropdown-submenu [data-toggle="dropdown"]'); // Methods
...
var FormControl = function () {
  ...
  var $input = $('.form-control'),
      $indeterminateCheckbox = $('[data-toggle="indeterminate"]'); // Methods
    ...
    $(window).on({
      'scroll': function scroll() {
        ...
        setInterval(function () {
          if (scrolling) {
            scrolling = false; // Sticky navbar init
...
var GoogleMapCustom = function () {
  ...
  function initMap(map) {
    ...
    var contentString = '<div class="info-window-content"><h5>Company Name</h5>' + '<p>Description comes here...</p></div>';
...
var GoogleMap = function () {
  ...
  function initMap(map) {
    ...
    var contentString = '<div class="info-window-content"><h2>{{ site.product.name }} {{ site.product.name_long }}</h2>' + '<p>{{ site.product.description }}</p></div>';
    var infowindow = new google.maps.InfoWindow({
      content: contentString
    });
    google.maps.event.addListener(marker, 'click', function () {
...
var Countdown = function () {
  ...
  function init($this) {
    var date = $this.data('countdown-date'),
        template = '<div class="countdown-item"><span class="countdown-digit">%-D</span><span class="countdown-label countdown-days">day%!D</span></div>' + '<div class="countdown-item"><span class="countdown-digit">%H</span><span class="countdown-separator">:</span><span class="countdown-label">hrs</span></div>' + '<div class="countdown-item"><span class="countdown-digit">%M</span><span class="countdown-separator">:</span><span class="countdown-label">min</span></div>' + '<div class="countdown-item"><span class="countdown-digit">%S</span><span class="countdown-label">sec</span></div>';
...
var Notify = function () {
  // Variables
  var $notifyBtn = $('[data-toggle="notify"]'); // Methods
...
var ProgressCircle = function () {
  // Variables
  var $progress = $('.progress-circle'); // Methods
...
var WpxSwiper = function () {
  ...
  function init($this) {
    ...
    var effect = $el.data('swiper-effect') ? $el.data('swiper-effect') : 'slide',
        ...
        paginationType = $el.data('swiper-pagination-type') ? $el.data('swiper-pagination-type') : 'bullets'; // Items per slide
...
var ApexOrdersChart = function () {
  ...
  var $chart = document.querySelector("#apex-orders"),
      ...
      chart;
  var colorPalette = [PurposeStyle.colors.theme['primary'], PurposeStyle.colors.theme['warning']];
  ...
  function init() {
    ...
    var height = $chart.dataset.height; // Inject synamic properties

    options.colors = colorPalette;
    options.chart.height = height ? height : 350;
    chart = new ApexCharts($chart, options); // Draw chart
...
//# sourceMappingURL=/quick-website.284fe133.js.map